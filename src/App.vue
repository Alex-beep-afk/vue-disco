      ...
      <div class="flex flex-row ">
        ...
        <main class="bg-white py-5 ml-6 basis-auto">
            ...
            <section class="text-gray-600 body-font">
                <!-- one records -->
                <div class="container px-5 mx-auto"v-for="album in localRecords">
                  ...
                  <div class="w-full">
                    <div class="float-right">
                      <button type="button" class="border border-teal-500 bg-teal-500 text-white rounded-md px-4 py-2 m-2 ease select-none hover:bg-teal-400" @click = "addCompteur"> + </button>
                      <span>{{compteur}}</span>
                      <button type="button" class="border border-teal-500 bg-teal-500 text-white rounded-md px-4 py-2 m-2 ease select-none hover:bg-purple-800"@click = "decreaseCompteur"> - </button>
                    </div>
                  </div>
                  </div>
                </div>
